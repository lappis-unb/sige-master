    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('serial_number', models.CharField(help_text='This field is required', max_length=8, unique=True, verbose_name='serial number')),
                ...
                ('id_in_slave', models.IntegerField(default=0)),
                ...
                ('grouping', models.ManyToManyField(help_text='This field is required', to='groups.Group', verbose_name='Grouping')),
                ...
                ('slave_server', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='slaves.Slave', verbose_name='Collection Server')),
            ],
            options={
