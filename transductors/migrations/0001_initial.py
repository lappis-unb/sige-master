    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slave_server', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='transductors', to='slaves.Slave', verbose_name='Collection Server')),
            ],
            options={
