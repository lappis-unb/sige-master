...
def get_several_events_in_different_states_response():
    ...
    return [
        ("FailedConnectionTransductorEvent", failed_conn_event_response),
        ("VoltageRelatedEvent", voltage_related_event_response),
    ]
...
class GetEventsFromTransductorsTestCase(TestCase):
    ...
    #     return_value=get_event_response("FailedConnectionTransductorEvent", "2021-03-08T16:04:03"),
    # )
    # @mock.patch("events.models.fcm_send_topic_message", return_value=None)
    # def test_start_failed_connection_event(self, mock_events_request, mock_topic_message):
    ...
    #     self.assertEqual(datetime(2021, 3, 8, 16, 4, 3), failed_events[0].created_at)
    #     self.assertEqual(None, failed_events[0].ended_at)

    # @mock.patch(
    #     "slaves.utils.request_all_events",
    #     side_effect=[
    #         get_event_response("FailedConnectionTransductorEvent", "2021-03-08T16:04:03"),
    #         get_event_response("FailedConnectionTransductorEvent", "2021-03-08T16:04:03", "2021-03-08T16:05:03"),
    #     ],
    # )
    # @mock.patch("events.models.fcm_send_topic_message", return_value=None)
    # def test_finish_failed_connection_event(self, mock_events_request, mock_topic_message):
    #     DataCollector.get_events()
    #     DataCollector.get_events()
    ...
    #     self.assertEqual(1, len(failed_events))
    #     self.assertEqual(self.energy_transductor, failed_events[0].transductor)
    #     self.assertEqual(datetime(2021, 3, 8, 16, 4, 3), start_event)
    #     self.assertEqual(datetime(2021, 3, 8, 16, 5, 3), end_event)
    #     self.assertEqual(60, event_interval.seconds)

    # @mock.patch(
    #     "slaves.utils.request_all_events",
    #     return_value=get_event_response("CriticalVoltageEvent", "2021-03-08T16:04:03"),
    # )
    # @mock.patch("events.models.fcm_send_topic_message", return_value=None)
    # def test_start_critical_voltage_event(self, mock_events_request, mock_topic_message):
    #     DataCollector.get_events()

    #     critical_volt_events = list(CriticalVoltageEvent.objects.all())

    #     self.assertEqual(1, len(critical_volt_events))
    #     self.assertEqual(self.energy_transductor, critical_volt_events[0].transductor)
    #     self.assertEqual(datetime(2021, 3, 8, 16, 4, 3), critical_volt_events[0].created_at)
    #     self.assertEqual(None, critical_volt_events[0].ended_at)

    # @mock.patch(
    #     "slaves.utils.request_all_events",
    #     side_effect=[
    #         get_event_response("CriticalVoltageEvent", "2021-03-08T16:04:03"),
    #         get_event_response("CriticalVoltageEvent", "2021-03-08T16:04:03", "2021-03-08T17:04:03"),
    #     ],
    # )
    # @mock.patch("events.models.fcm_send_topic_message", return_value=None)
    # def test_finish_critical_voltage_event_interval_1_hour(self, mock_events_request, mock_topic_message):
    #     DataCollector.get_events()
    #     DataCollector.get_events()
    ...
    #     self.assertEqual(self.energy_transductor, critical_volt_events[0].transductor)
    #     self.assertEqual(datetime(2021, 3, 8, 16, 4, 3), start_event)
    #     self.assertEqual(datetime(2021, 3, 8, 17, 4, 3), end_event)
    #     self.assertEqual(3600, event_interval.seconds)

    # @mock.patch(
    #     "slaves.utils.request_all_events",
    #     return_value=get_event_response("PrecariousVoltageEvent", "2021-03-08T16:04:03"),
    # )
    # @mock.patch("events.models.fcm_send_topic_message", return_value=None)
    # def test_start_precarious_voltage_event(self, mock_events_request, mock_topic_message):
    #     DataCollector.get_events()

    #     precarious_volt_events = list(PrecariousVoltageEvent.objects.all())

    #     self.assertEqual(1, len(precarious_volt_events))
    #     self.assertEqual(self.energy_transductor, precarious_volt_events[0].transductor)
    #     self.assertEqual(datetime(2021, 3, 8, 16, 4, 3), precarious_volt_events[0].created_at)
    #     self.assertEqual(None, precarious_volt_events[0].ended_at)

    # @mock.patch(
    #     "slaves.utils.request_all_events",
    #     side_effect=[
    #         get_event_response("PrecariousVoltageEvent", "2021-03-08T16:04:03"),
    #         get_event_response("PrecariousVoltageEvent", "2021-03-08T16:04:03"),
    #     ],
    # )
    # @mock.patch("events.models.fcm_send_topic_message", return_value=None)
    # def test_update_precarious_voltage_event_without_end_date(self, mock_events_request, mock_topic_message):
    #     DataCollector.get_events()
    #     DataCollector.get_events()
    ...
    # @mock.patch(
    #     "slaves.utils.request_all_events", return_value=get_event_response("PhaseDropEvent", "2021-03-08T16:04:03")
    # )
    # @mock.patch("events.models.fcm_send_topic_message", return_value=None)
    # def test_start_phase_drop_event(self, mock_events_request, mock_topic_message):
    #     DataCollector.get_events()

    #     phase_drop_events = list(PhaseDropEvent.objects.all())

    #     self.assertEqual(1, len(phase_drop_events))
    #     self.assertEqual(self.energy_transductor, phase_drop_events[0].transductor)
    #     self.assertEqual(datetime(2021, 3, 8, 16, 4, 3), phase_drop_events[0].created_at)
    #     self.assertEqual(None, phase_drop_events[0].ended_at)

    # @mock.patch(
    #     "slaves.utils.request_all_events",
    #     side_effect=[
    #         get_event_response("PhaseDropEvent", "2021-03-08T16:04:03"),
    #         get_event_response("PhaseDropEvent", "2021-03-08T17:04:03"),
    #         get_event_response("PhaseDropEvent", "2021-03-08T17:04:03", "2021-03-08T18:05:05"),
    #     ],
    # )
    # @mock.patch("events.models.fcm_send_topic_message", return_value=None)
    # def test_update_and_finish_phase_drop_event_interval_2_hours(self, mock_events_request, mock_topic_message):
    ...
    # self.assertEqual(self.energy_transductor, phase_drop_events[0].transductor)
    # self.assertEqual(datetime(2021, 3, 8, 16, 4, 3), start_event)
    # self.assertEqual(datetime(2021, 3, 8, 18, 5, 5), end_event)
    ...
    #     side_effect=[
    #         get_event_response("PhaseDropEvent", "2021-03-08T16:04:03"),
    #         get_event_response("PhaseDropEvent", "2021-03-08T16:04:03", "2021-03-08T17:04:05"),
    #         get_event_response("PhaseDropEvent", "2021-03-08T18:05:05"),
    #     ],
    # )
    # @mock.patch("events.models.fcm_send_topic_message", return_value=None)
    # def test_create_two_phase_drop_events(self, mock_events_request, mock_topic_message):
    ...
    #     self.assertEqual(self.energy_transductor, phase_drop_events[0].transductor)
    #     self.assertEqual(datetime(2021, 3, 8, 16, 4, 3), start_event_1)
    #     self.assertEqual(datetime(2021, 3, 8, 17, 4, 5), end_event_1)
    ...
    #         get_event_response("CriticalVoltageEvent", "2021-03-08T16:04:03"),
    #         get_event_response("PrecariousVoltageEvent", "2021-03-08T16:04:03"),
    #         get_event_response("PrecariousVoltageEvent", "2021-03-08T16:10:03"),
    #         get_event_response("PrecariousVoltageEvent", "2021-03-08T16:04:03", "2021-03-08T17:04:03"),
    #         get_several_events_in_different_states_response(),
    #     ],
    # )

    # @mock.patch("events.models.fcm_send_topic_message", return_value=None)
    # def test_several_events_on_same_transductor(self, mock_events_request, mock_topic_message):
    ...
    #     failed_events_interval = failed_events[0].ended_at - failed_events[0].created_at
    #     self.assertEqual(1, len(failed_events))
    #     self.assertEqual(self.energy_transductor, failed_events[0].transductor)
    #     self.assertEqual(datetime(2021, 3, 8, 16, 4, 3), failed_events[0].created_at)
    #     self.assertEqual(datetime(2021, 3, 8, 16, 5, 4), failed_events[0].ended_at)
    #     self.assertEqual(61, failed_events_interval.seconds)
    ...
    #     precarious_1_interval = precarious_volt_events[0].ended_at - precarious_volt_events[0].created_at
    #     self.assertEqual(2, len(precarious_volt_events))
    #     self.assertEqual(self.energy_transductor, precarious_volt_events[0].transductor)
    #     self.assertEqual(datetime(2021, 3, 8, 16, 4, 3), precarious_volt_events[0].created_at)
    #     self.assertEqual(datetime(2021, 3, 8, 17, 4, 3), precarious_volt_events[0].ended_at)
    #     self.assertEqual(3600, precarious_1_interval.seconds)
    #     self.assertEqual(datetime(2021, 3, 8, 18, 4, 3), precarious_volt_events[1].created_at)
