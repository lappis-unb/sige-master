...
class MeasurementsTestCase(TestCase):
    ...
    def test_contains_expected_fields(self):
        atp_serializer = MinutelyApparentPowerThreePhaseSerializer(instance=self.minutely_measurements,
                                                                   context=self.serializer_context).data
        self.assertEqual(set(atp_serializer.keys()), set(['id', 'transductor',
                                                        'collection_time',
                                                        'apparent_power_a',
                                                        'apparent_power_b',
                                                        'apparent_power_c',]))
