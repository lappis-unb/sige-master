...
from measurements.models import EnergyTransductor, MinutelyMeasurement
from users.models import CustomUser


class MeasurementsEndPointsTestCase(TestCase):
    def setUp(self):
        self.__user = CustomUser.objects.create(email="admin@admin.com", password="admin")
        self.__user.save()
        self.__credentials = ("admin@admin.com", "admin")
        self.__api_client = APIClient()
        self.__minutely_three_phase = "/graph/minutely-threephase-voltage/"
        self.__minutely_simple_phase = "/graph/minutely-total-active-power/"
    ...
    def test_get_with_auth_minutely_three_phase(self):
        ...
        self.assertEqual(["01/13/2021 00:00:00", 220.2], content["phase_a"][0])
        self.assertEqual(["01/13/2021 00:10:00", 225.1], content["phase_a"][1])
    ...
    def test_get_with_auth_minutely_three_phase(self):
        ...
        self.assertEqual(225.1, content["max"])
        self.assertEqual(217.3, content["min"])
        self.assertEqual(["01/13/2021 00:00:00", 220.2], phase_a_measurements[0])
        self.assertEqual(["01/13/2021 00:01:00", 0], phase_a_measurements[1])
        self.assertEqual(["01/13/2021 00:10:00", 0], phase_a_measurements[10])
        self.assertEqual(["01/13/2021 00:11:00", 225.1], phase_a_measurements[11])
    ...
    def test_get_with_auth_minutely_three_phase_lttb_filter(self):
        ...
        params = "?id={}&start_date={}&is_filtered={}".format(self.transductor.id, "2021-01-01 00:00:00", "True")
        endpoint = self.__minutely_three_phase + params
    ...
    def test_get_without_auth_minutely_three_phase(self):
        params = "?id={}&start_date={}&end_date={}".format(
            self.transductor.id, "2019-01-01 00:00:00", "2019-01-01 23:59:00"
        )
    ...
    def test_get_with_auth_minutely_simple_phase(self):
        ...
        params = "?id={}&start_date={}".format(self.transductor.id, "2021-01-01 00:00:00")
        ...
        self.assertEqual(["01/13/2021 00:00:00", 2200], measurements[0])
        self.assertEqual(["01/13/2021 00:10:00", 2250], measurements[1])

    def test_post_with_auth_minutely_three_phase(self):
        self.__api_client.login(email="admin@admin.com", password="admin")

        response = self.__api_client.post(self.__minutely_three_phase)
    ...
    def test_put_with_auth_minutely_three_phase(self):
        ...
        response = self.__api_client.put(self.__minutely_three_phase)
    ...
    def test_delete_with_auth_minutely_three_phase(self):
        ...
        response = self.__api_client.delete(self.__minutely_three_phase)
